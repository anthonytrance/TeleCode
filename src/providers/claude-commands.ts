...
const CLAUDE_COMMAND_SPECS = [
  ...
  spec("context", "surface", "Show context usage known to TeleCodex."),
  ...
  spec("clear", "emulate", "Forget the current TeleCodex Claude session."),
  spec("resume", "emulate", "Resume or switch Claude sessions through TeleCodex."),
  spec("branch", "emulate", "Branch a Claude session through TeleCodex."),
  spec("fork", "emulate", "Fork a Claude session through TeleCodex."),
  spec("rename", "emulate", "Rename a Claude session through TeleCodex."),
  spec("export", "emulate", "Export Claude session information through TeleCodex."),
  spec("copy", "emulate", "Re-send the last assistant message."),
  spec("rewind", "emulate", "Rewind through TeleCodex when supported."),
  spec("background", "emulate", "Move a session to the background.", { aliases: ["bg"] }),
  spec("exit", "emulate", "Dispose the current Claude process."),

  spec("cost", "surface", "Show Claude usage known to TeleCodex."),
  spec("status", "surface", "Show current Claude session status."),
  spec("stats", "surface", "Show Claude usage known to TeleCodex."),
  ...
  spec("usage", "surface", "Show Claude usage known to TeleCodex."),
